...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Left side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 lorenz-gradient-subtle items-center justify-center relative overflow-hidden">
        {/* Decorative elements */}
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-2xl font-medium mb-2">Bentornato</h2>
          <p className="text-muted-foreground mb-8">
            Accedi al tuo account per continuare
          </p>

          {error && (
            <div className="mb-4 p-4 bg-destructive/10 rounded-xl text-destructive text-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 px-4 bg-primary/15 text-primary font-medium rounded-xl
          ...
          <div className="mt-8 pt-8 border-t border-border/50">
            ...
            <div className="flex gap-3">
              <button className="flex-1 py-3 px-4 bg-muted/50 rounded-xl hover:bg-muted transition-smooth flex items-center justify-center gap-2 text-sm font-medium">
